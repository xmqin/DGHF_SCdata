...
for natom in 1296 5184  11664  20736 46656  82944 186624
...
printf "%16s  %16s  %16s  %16s  %16s  %16s  %16s  %16s \n" "$natom" "$nele"  " $time_ALB" " $time_DG" " $time_DGHFX " " $time_Diag " "$time_Density"  "$time_SCF" #"$time_symfac"  "$time_pole"
#printf "\n"
#printf "|$marker $marker1 $marker2|\n"
